SELECT DNUM AS FOLIO, DREFERELLOS AS REFERENCIA, DPAR0 AS PROVEEDOR,
TIDESCR AS TIPO_MOV, CATDESCR AS TIENDA,IEAN AS EAN,ICOD AS MODELO,IDESCR AS DESCRIPCION,FAM2.FAMDESCR AS DEPARTAMENTO,
...
AICANTF AS UNIDADES,AICOSTO  AS COSTO_C_IVA,AICOSTO * AICANTF * 1.16 AS COSTO_TOTAL,AIPRECIO AS PRECIO,
...
WHERE (DITIPMV='R' OR  DITIPMV='W' OR  DITIPMV='RT'  OR DITIPMV='I' OR DITIPMV='EI' OR DITIPMV='RX')
