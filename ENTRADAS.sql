SELECT MID(ICOD,1,11) AS CODIGO_COLOR,
IDESCR AS TIPO_MOV, CATDESCR AS TIENDA,IEAN AS EAN,SUBSTRING(ICOD,1,9)AS MODELO_PADRE,ICOD AS MODELO,IDESCR AS DESCRIPCION,FAM2.FAMDESCR AS DEPARTAMENTO,
...
WHERE (DITIPMV='I' OR DITIPMV='W' OR DITIPMV='R' OR  DITIPMV='IF' OR DITIPMV='EI' OR DITIPMV='SI' OR DITIPMV='J') AND (AIALMACEN < 12 OR  AIALMACEN > 303)
