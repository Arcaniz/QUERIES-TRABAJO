...
IF(CATMULTICIA = 1, ILISTA8*ALMCANT,IF(CATMULTICIA=2, ILISTA5*ALMCANT,IF (CATMULTICIA=3,ILISTA3*ALMCANT, IF (CATMULTICIA=4,ILISTA2*ALMCANT,ILISTA2*ALMCANT))))AS 'COSTO TOTAL',
ILISTA1 AS PRECIO,
FAM1.FAMDESCR AS PROVEEDOR,
FAM3.FAMDESCR AS TIPO,FAM4.
FAMDESCR AS SUBTIPO,FAM5.
FAMDESCR AS PERSONAJE,
FAM6.FAMDESCR AS TRIMESTRE,
FAM7.FAMDESCR AS DISENADOR,
FAM8.FAMDESCR AS LICENCIA,
FAM9.FAMDESCR AS 'TIPO DE LICENCIA',
FAMA.FAMDESCR  AS OFERTAS,
CATDESCR AS TIENDA,
CATCONTACTO AS EMPRESA,
...
AND (ALMNUM<> 501 AND ALMNUM<> 0 AND ALMNUM <> 910 AND ALMNUM<> 911 AND ALMNUM<> 912 AND ALMNUM<> 913 AND ALMNUM<> 914 AND ALMNUM<> 915 )
