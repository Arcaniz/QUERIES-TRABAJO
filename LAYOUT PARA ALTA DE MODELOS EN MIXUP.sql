SELECT IEAN AS EAN, IDESCR AS TITULO,'---'AS DEPTO,
'---'AS SUBDEPTO, '---'AS CLASIFICACION, '---'AS INTERPRETE,
MID(ICOD,10,2) AS COLOR, MID(ICOD,12,2) AS TALLA,'' AS MARCA,
' ' AS PUBLICAR, ' ' AS STATUS, ' ' AS CATEGORIA, ICODSAT AS COD_SAT,
FAM3.FAMDESCR AS DESCRIPCION_SAT,'---'AS COMPOSITOR, '---'AS DIRECTOR,
'---'AS PR,'---'AS FECHA_PREVENTA, ICOD AS COD_PROVEEDOR,'---'AS PROCEDENCIA,
'---'AS COD_SERIE,' ' AS CLAVE_ART,'98' AS COSTO_BRUTO,'---'AS DESCR_COMER, '113.86' AS COSTO_NETO,
ilista1 AS PVTA,
