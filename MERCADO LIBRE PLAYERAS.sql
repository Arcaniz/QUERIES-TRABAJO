...
Archivo para exportar de PROSCAI a MERCADO LIBRE, NO CONSIDERA EXISTENCIAS POR AHORA 
*/

SELECT


IF(LENGTH(CONCAT(FAM3.FAMDESCR,' TOXIC  ','CON ESTAMPADO DE ',FAM5.FAMDESCR))>60, CONCAT(FAM3.FAMDESCR,' TOXIC  ',' ',FAM5.FAMDESCR),CONCAT(FAM3.FAMDESCR,' TOXIC  ','CON ESTAMPADO DE ',FAM5.FAMDESCR))
AS 'Título: ingresa solo producto, marca y modelo 
Obligatorio',
 IEAN AS 'Código universal de producto',
CATDESCR AS' Varía por: Color 
Obligatorio',
CATDESCR AS 'Varía por: Nombre comercial del color 
Obligatorio',
FAM5.FAMDESCR AS 'Varía por: Diseño impreso',
IF(MID(ICOD,12,13)= 'CH','S', IF(MID(ICOD,12,13)='MD','M',IF(MID(ICOD,12,13)='GD','L',IF(MID(ICOD,12,13)='EG','XL',IF(MID(ICOD,12,13)='UN','UNITALLA',MID(ICOD,12,13)))))) AS 'Varía por: Talla 
Obligatorio',
NULL AS 'Imágenes 
Obligatorio',
MID(ICOD,1,9) AS SKU,
...
'Nuevo' AS 'Condición 
Obligatorio',
CONCAT(FAM3.FAMDESCR,' TOXIC ESTILO ',FAM4.FAMDESCR,' ',FAM2.FAMDESCR,' CON ESTAMPADO DE ',FAM5.FAMDESCR,' MODELO ',MID(ICOD,1,9)) AS
Descripción,
NULL AS'Link de YouTube', 
'Premium' AS 'Tipo de publicación 
Obligatorio',
'Mercado Envíos' AS 
'Forma de envío 
Obligatorio',
'A cargo del comprador' AS 'Costo de envío 
Obligatorio',
'No acepto' AS 'Retiro en persona 
Obligatorio',
'Garantía del vendedor' AS 'Tipo de garantía',
'30' AS 'Tiempo de garantía',
'días' AS 'Unidad de Tiempo de garantía',
'Toxic' AS 'Marca 
Obligatorio',
IF(FAM2.FAMDESCR ='CABALLERO','Hombre',IF(FAM2.FAMDESCR ='DAMA','Mujer',FAM2.FAMDESCR)) AS 'Género 
Obligatorio',
IF(FAM4.FAMDESCR='MANGA LARGA', 'Larga',IF(FAM4.FAMDESCR='TANK TOP', 'Musculosa','Corta')) AS'Tipo de manga 
Obligatorio',
MID(ICOD,1,9) AS Modelo,
'Liso' AS 'Diseño de la tela',
'1' AS 'Unidades por envase',
IF(FAM4.FAMDESCR='SNOW O JASPE', 'Poliéster','Algodón') AS 'Material principal',
'Redondo' AS 'Tipo de cuello'
