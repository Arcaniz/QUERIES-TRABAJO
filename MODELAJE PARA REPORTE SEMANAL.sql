select MID(ICOD,1,11)AS MODELO_COLOR,
ICOD AS MODELO,IDESCR AS DESCRIPCION,FAM2.FAMDESCR AS DEPARTAMENTO,
ILISTA4 AS COSTO,ILISTA1 AS PRECIO,
FAM1.FAMDESCR AS PROVEEDOR,FAM3.FAMDESCR AS TIPO,FAM4.FAMDESCR AS SUBTIPO,FAM5.FAMDESCR AS PERSONAJE,
FAM6.FAMDESCR AS TRIMESTRE,FAM7.FAMDESCR AS DISEÑADOR,FAM8.FAMDESCR AS LICENCIA, FAM9.FAMDESCR AS TIPO_DE_LICENCIA,FAMA.FAMDESCR,SUBSTRING(ICOD,1,9)AS MODELO_PADRE
