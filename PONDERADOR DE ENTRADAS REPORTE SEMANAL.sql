SELECT MID(ICOD,1,11) AS 'CODIGO COLOR',
IDESCR AS 'TIPO DE MOVIMIENTO', 
...
IEAN AS EAN,
SUBSTRING(ICOD,1,9)AS 'MODELO PADRE',
ICOD AS MODELO,
...
SUM(AICANT) AS 'PONDERADOR DE ENTRADAS'
...
/** EXCLUYE ALMACEN CENTRAL, PATROCINIOS, MERMA, OSOM, MUESTRAS, MATERIA PRIMA,EXPOS (918) Y SANTORY **/
WHERE (DITIPMV='I' OR DITIPMV='W' OR DITIPMV='DT'  OR DITIPMV='DC' OR DITIPMV='DL' OR DITIPMV='G' OR DITIPMV='FK'  OR DITIPMV='FT' OR DITIPMV='R' OR DITIPMV='RT' OR DITIPMV='RX' OR  DITIPMV='IF' OR DITIPMV='EI' OR DITIPMV='SI' OR DITIPMV='J')
AND (AIALMACEN <> 0 AND AIALMACEN <> 910  AND AIALMACEN <> 911 AND AIALMACEN <> 912 AND AIALMACEN <> 913  AND AIALMACEN <> 914 AND AIALMACEN <> 915 AND AIALMACEN <> 916 AND AIALMACEN <> 917  AND AIALMACEN <> 918 AND AIALMACEN <> 920 AND AIALMACEN <> 921 AND AIALMACEN <> 923 AND AIALMACEN <> 928 and AIALMACEN <> 930  and AIALMACEN <> 933)
