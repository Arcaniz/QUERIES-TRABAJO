...
TIDESCR AS 'TIPO DE MOVIMIENTO',
DREFER AS 'FACTURA/TICKET',
...
AICANTF AS 'VENTA EN UNIDADES',
AICOSTO AS COSTO,
AICOSTO * 1.16  AS 'COSTO CON IVA',
...
CLICOD AS 'CODIGO DE CLIENTE',
CLINOM AS CLIENTE,
DMULTICIA AS 'NUMERO DE CIA',
