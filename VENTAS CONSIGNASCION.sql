...
SELECT IEAN AS EAN,ICOD AS MODELO,IDESCR AS DESCRIPCION,FAM2.FAMDESCR AS DEPARTAMENTO,
AICANTF AS VENTA_EN_UNIDADES,ILISTA5 AS COSTO,ILISTA5 * AICANTF AS COSTO_TOTAL,
AIPRECIO AS PRECIO,AIPRECIO * AICANTF AS PRECIO_TOTAL,FAM1.FAMDESCR AS PROVEEDOR,
...
AND (FAM1.FAMDESCR= 'FONT SILVER' or FAM1.FAMDESCR= 'MOGOBIKES MEXICO' or FAM1.FAMDESCR= 'COMER.ORC, S.A')
